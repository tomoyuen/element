...
import locale from 'element-ui-custom-ac/lib/locale/lang/en'
...
import lang from 'element-ui-custom-ac/lib/locale/lang/en'
import locale from 'element-ui-custom-ac/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/element-ui-custom-ac[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'element-ui-custom-ac/lib/locale/lang/en')
  ]
}
```
...
import Element from 'element-ui-custom-ac'
import enLocale from 'element-ui-custom-ac/lib/locale/lang/en'
import zhLocale from 'element-ui-custom-ac/lib/locale/lang/zh-CN'
...
import enLocale from 'element-ui-custom-ac/lib/locale/lang/en'
import zhLocale from 'element-ui-custom-ac/lib/locale/lang/zh-CN'
import ElementLocale from 'element-ui-custom-ac/lib/locale'
...
<script src="//unpkg.com/element-ui-custom-ac"></script>
<script src="//unpkg.com/element-ui-custom-ac/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/element-ui-custom-ac"></script>
<script src="//unpkg.com/element-ui-custom-ac/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/element-ui-custom-ac/lib/umd/locale/en.js"></script>
