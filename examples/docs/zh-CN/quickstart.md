...
```javascript
import Vue from 'vue'
import ElementUI from 'element-ui-custom-ac'
import 'element-ui-custom-ac/lib/theme-default/index.css'
...
```json
{
  ...
  "plugins": [["component", [
    {
      "libraryName": "element-ui-custom-ac",
...
```javascript
import Vue from 'vue'
import { Button, Select } from 'element-ui-custom-ac'
import App from './App.vue'
